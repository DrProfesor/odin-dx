...
ID3D11VideoDevice2Vtbl :: struct {
    ...
    CheckFeatureSupport : proc(This: ^ID3D11VideoDevice2, Feature: D3D11_FEATURE_VIDEO, pFeatureSupportData: rawptr, FeatureSupportDataSize: UINT) -> HRESULT,
    NegotiateCryptoSessionKeyExchangeMT : proc(This: ^ID3D11VideoDevice2, pCryptoSession: ^ID3D11CryptoSession, flags: D3D11_CRYPTO_SESSION_KEY_EXCHANGE_FLAGS, DataSize: UINT, pData: rawptr) -> HRESULT,
}
...
D3D11_FEATURE_VIDEO :: enum u32{
    D3D11_FEATURE_VIDEO_DECODER_HISTOGRAM =  0
    ,
}
D3D11_VIDEO_DECODER_HISTOGRAM_COMPONENT :: enum u32{
...
D3D11_VIDEO_DECODER_HISTOGRAM_COMPONENT_FLAGS :: enum u32{
    D3D11_VIDEO_DECODER_HISTOGRAM_COMPONENT_FLAG_NONE =  0,
    D3D11_VIDEO_DECODER_HISTOGRAM_COMPONENT_FLAG_Y =  ( 1 << 0 ) ,
    D3D11_VIDEO_DECODER_HISTOGRAM_COMPONENT_FLAG_U =  ( 1 << 1 ) ,
    D3D11_VIDEO_DECODER_HISTOGRAM_COMPONENT_FLAG_V =  ( 1 << 2 ) ,
    D3D11_VIDEO_DECODER_HISTOGRAM_COMPONENT_FLAG_R =  ( 1 << 0 ) ,
    D3D11_VIDEO_DECODER_HISTOGRAM_COMPONENT_FLAG_G =  ( 1 << 1 ) ,
    D3D11_VIDEO_DECODER_HISTOGRAM_COMPONENT_FLAG_B =  ( 1 << 2 ) ,
    D3D11_VIDEO_DECODER_HISTOGRAM_COMPONENT_FLAG_A =  ( 1 << 3 )
    ,
}
D3D11_CRYPTO_SESSION_KEY_EXCHANGE_FLAGS :: enum u32{
